Public Class FRM_HISTORY_GINGUB

    Private ss As New CRMmanager
    Private result As Integer = 0
    Private Sub FRM_HISTORY_GINGUB_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Call SettoolBar(False, True, False, False, False, True, True)
    End Sub

    Private Sub FRM_HISTORY_GINGUB_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            setComboSelect(cboHandleType, 1) 'cboHandleType.SelectedIndex = 1
            dt1 = Nothing
        ...
        Catch ex As Exception
            Call WriteLog("FRM_HISTORY_GINGUB : " & ex.ToString)
        End Try
    ...
    Public Sub gsSelect(ByVal isInit As Boolean)
        Try
            ...
            DataGridView2.Columns.Item(5).HeaderText = "처리유형"
    ...
    Private Sub DataGridView2_CellMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView2.CellMouseClick
        Try
            ...
            With DataGridView2.Rows(i)
                ...
                txtHandleType.Text = .Cells(5).Value.ToString
    ...
    Private Sub FRM_HISTORY_GINGUB_Deactivate(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Deactivate
        Call gsFormExit()
    End Sub
